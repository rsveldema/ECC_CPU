...
namespace ecc
{
	...
	public:
		Core(SimComponentRegistry& registry, ecc::CoreID core_id, GlobalStats& stats)
			...
			regs{},
			fetch(registry, fetch_decode_bus, core_L1i, ecc::createBusID(core_id, ecc::CoreComponentID::COMPONENT_TYPE_FETCH),
			...
			store(registry, execute_store_bus, store_to_vec_controller_bus, regs, ecc::createBusID(core_id, ecc::CoreComponentID::COMPONENT_TYPE_STORE),
